...
const TEMPLATES = {
  ...
  html: { tool: 'html', actions: ['fmt', 'min', 'esc', 'unesc'], defaultAction: 'fmt', inputName: 'input.html' },
  ...
  markdown: { tool: 'markdown', actions: ['html', 'preview'], defaultAction: 'html', inputName: 'input.md' },
  jsonp: { tool: 'jsonp', actions: ['strip'], defaultAction: 'strip', inputName: 'input.js' },
  ...
  gzip: { tool: 'gzip', actions: ['compress', 'decompress'], defaultAction: 'compress', inputName: 'input.txt' },
  'data-uri': { tool: 'datauri', actions: ['enc', 'dec'], defaultAction: 'enc', inputName: 'input.txt' },
  unicode: { tool: 'unicode', actions: ['esc', 'unesc', 'info'], defaultAction: 'esc', inputName: 'input.txt' },
  ...
  regex: { tool: 'regex', actions: ['test', 'match'], defaultAction: 'test', inputName: 'input.txt' },
